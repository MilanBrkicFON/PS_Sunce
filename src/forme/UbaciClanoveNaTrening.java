 ...
 * @author Milan
 */
public class UbaciClanoveNaTrening extends javax.swing.JDialog {

    private final List<Clan> clanovi;
    private Trening trening;
    private PanelZaPrikazTreninga forma;
    /**
     * Creates new form UbaciClanoveUTrening
     */
    public UbaciClanoveNaTrening(java.awt.Frame parent, boolean modal) throws Exception {
        super(parent, modal);
    ...
    public UbaciClanoveNaTrening(java.awt.Frame parent, boolean modal, Trening trening) throws Exception {
        this(parent, modal);
        this.trening = trening;

    }

    public UbaciClanoveNaTrening(java.awt.Frame parent, boolean b, Trening trening, PanelZaPrikazTreninga aThis) throws Exception {
        this(parent, b, trening);
        forma = aThis;
    }
            ...
            if (rowSelectedViewModel != -1) {
                ...
                if (trening.getClanovi().contains(c)) {
                    ...
                    try {
                        ...
                        ((ListModelClanovi)forma.getjListClanova().getModel()).addClan(c);
                        forma.refresh();
    ...
    private void postaviPanele() {
        try {
            ...
            Logger.getLogger(UbaciClanoveNaTrening.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
